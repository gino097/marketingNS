...
const reporteGeneral_Excel_Pro4 = asyncHandler(async (sucursal, res) => {
  ...
  var comando;
  comando = "SELECT " + campos.toString() + " FROM dbo.sy_inventario_materiales WHERE MATE_ESTADO='ACTIVO' AND MATE_CIUDAD = 'Cochabamba'";
  objRep.generico_reporteGeneral_ExcelImagenes(res,comando,headingColumnNames,camposF,"EMISIÓN PRODCUTOS");
});

module.exports = {
  reporteGeneral_Excel_Pro4,
};
