...
lugar: "Santa Cruz" SOLI_LUGARX */
  ...
  campos=["SOLI_FECSOL",
   ...
   // "SOLI_PRACTICADEPORTES",
    ...
    "SOLI_INGIEREALCOHOL",
    "SOLI_DETALLEINGIEREALCOHOL",
    "SOLI_FRECUENCIAALCOHOL",
    "SOLI_TIEMPOALCOHOL",
...
//231
    ...
    var nombresC=["fecha_solicitud" ,
     ...
     // "literal_4_1_3_deporte" ,
      ...
      "literal_4_1_8" ,
      "literal_4_1_8_bebidas" ,
      "literal_4_1_8_frecuencia" ,
      "literal_4_1_8_veces_mes" ,
      "literal_4_1_9" ,
      ...
      Object.keys(userData).map(nombre=>{
        if(nombresC.includes(nombre.toString()))
        {
          ...
          //literal_1_2_nombres, literal_1_13_direccion, literal_1_12_nit
          //if(nombre==="literal_1_1"){if(userData[nombre]==="Tomador"){userData }}
          valores.push(userData[nombre]);
        }
   
        //if(userData[nombre]==="true"){userData[nombre]="Si"}
        //else if(userData[nombre]==="false"){userData[nombre]="No"}
        //valores.push(userData[nombre]);
...
"SOLI_DEFECTOFISICOFECHA","SOLI_DEFORMACIONFECHA","SOLI_ENFERMEDADFECHA","SOLI_LESIONFECHA"
], ['',''], res);
