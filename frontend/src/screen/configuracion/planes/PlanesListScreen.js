...
import ModalEliminar from "../planes/ModalEliminar";
...
import Form_Crud from "./Form_planes";
import { useNavigate } from "react-router-dom";

const PlanesListScreen = () => {
  ...
  const result = useSelector((state) => state.planList);
  const { pages, planes } = result;
        ...
        <Card className="dark:!bg-dark !rounded-none">
          <CardHeader color="white" contentPosition="none" className="!h-fit !py-5 !px-0 ">
            <div className="w-full flex md:justify-between items-baseline flex-col md:flex-row pl-4 dark:bg-dark">
              <h2 className="text-gray-800 text-base font-bold text-2xl pt-3 md:text-2xl dark:text-gray-100">Planes</h2>
          ...
          <div className="grid md:grid-cols-botones_crud grid-cols-2 mb-1 gap-y-4 pl-4 pr-4">
            ...
            >
              ...
              <h3 className="pr-2">Agregar Plan</h3>
            </div>
          </div>
            ...
            <div className=" overflow-x-auto border border-gray-50 rounded-md ">
              <table className="items-center w-full bg-transparent border-collapse">
                ...
                <tbody>
                  ...
                  {planes?.map((valor) => {
                    return (
                      <tr className="hover:bg-violet-200" key={valor.PLAN_CODIGO}>
                        ...
                        <td className="border-b border-gray-200 align-middle font-light text-sm whitespace-nowrap px-2 py-2 text-left px-3 py-2">
                          <div className="flex flex-row">
                            <div
                              ...
                              onClick={(e) => {
                                setShowModalTitulo("Editar Plan");
                                setTypeModal({
                                  codigo: valor.PLAN_CODIGO,
                                });
                            ...
                            <div
                              ...
                              onClick={(e) => {
                                ...
                                setTypeModal({
                                  ...typeModal,
                                  cabecera: "Eliminar Plan",
                                  cuerpo: "desea eliminar este registro ?",
                                  confirmacion: "borrar Pla n",
                                  codigo: valor.PLAN_CODIGO,
                                  funcion: "eliminar",
                                });
                              }}
...
export default PlanesListScreen;