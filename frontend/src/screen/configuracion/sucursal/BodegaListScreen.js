...
import { errorRedirectMensaje } from "../../../actions/seguridad/redirectErrorActions";
import ModalEliminar from "../sucursal/ModalEliminar";
...
import Form_Crud from "./Form_bodega";
import { useNavigate } from "react-router-dom";

const BodegaListScreen = () => {
  ...
  const result = useSelector((state) => state.bodegaList);
  const { pages, bodegas } = result;
  ...
  const modelModal = () => {
    ...
    if(typeModal.funcion==="activar"){
      //console.log(typeModal.confirmacion);
      return (
        <ModalActivar
          showModal={showModal}
          setShowModal={setShowModal}
    ...
    }else if(typeModal.funcion==="eliminar"){
    return (
      <ModalEliminar
        showModal={showModal}
        setShowModal={setShowModal}
        ...
        <Card className="dark:!bg-dark !rounded-none">
          <CardHeader color="white" contentPosition="none" className="!h-fit !py-5 !px-0 ">
            <div className="w-full flex md:justify-between items-baseline flex-col md:flex-row pl-4 dark:bg-dark">
              <h2 className="text-gray-800 text-base font-bold text-2xl pt-3 md:text-2xl dark:text-gray-100">Ciudades  </h2>
              <div className="my-2 pr-4 flex sm:flex-row flex-col">
                <div className="block relative w-full">
                  <span className="h-full absolute inset-y-0 left-0 flex items-center pl-2">
                    <svg
                      viewBox="0 0 24 24"
                      className="h-4 w-4 fill-curresnt text-gray-500"
                    >
          ...
          <div className="grid md:grid-cols-botones_crud grid-cols-2 mb-1 gap-y-4 pl-4 pr-4">
            ...
            <div
              onClick={(e) => {
                ...
                setShowModalTitulo("Crear Ciudad");
              }}
            ...
            >
              ...
              <h3 className="pr-2">Agregar Ciudad</h3>
            </div>
          </div>
            ...
            <div className=" overflow-x-auto border border-gray-50 rounded-md ">
              <table className="items-center w-full bg-transparent border-collapse">
                ...
                <tbody>
                  ...
                  {bodegas?.map((valor) => {
                    return (
                      <tr className="hover:bg-violet-200" key={valor.BODE_CODIGO}>
                        ...
                        <td className="border-b border-gray-200 align-middle font-light text-sm whitespace-nowrap px-2 py-2 text-left px-3 py-2">
                          <div className="flex flex-row">
                            <div
                              ...
                              onClick={(e) => {
                                setShowModalTitulo("Editar Ciudad");
                                setTypeModal({
                                  codigo: valor.BODE_CODIGO,
                                });
                            ...
                            {/*<div
                              ...
                              onClick={(e) => {
                                ...
                                setTypeModal({
                                  ...typeModal,
                                  cabecera: "Activa sucursal",
                                  cuerpo: "desea activar este registro ?",
                                  confirmacion: "activar sucursal",
                                  codigo: valor.BODE_CODIGO,
                                  funcion: "activar",
                                });
                              }}
                            ...
                            <div
                              ...
                              onClick={(e) => {
                                ...
                                setTypeModal({
                                  ...typeModal,
                                  cabecera: "Eliminar ciudad",
                                  cuerpo: "desea eliminar este registro ?",
                                  confirmacion: "borrar ciudad",
                                  codigo: valor.BODE_CODIGO,
                                  funcion: "eliminar",
                                });
                              }}
...
export default BodegaListScreen;