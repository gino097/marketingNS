...
import Form_Crud from "./Form_Usuario";
import Form_ChangePassword from "./Form_ChangePassword";
...
const CooperativaListScreen = () => {
  ...
  const result = useSelector((state) => state.cooperativaList);
  
  const { pages, cooperativas } = result;
        ...
        <Card className="dark:!bg-dark !rounded-none">
          <CardHeader color="white" contentPosition="none" className="!h-fit !py-5 !px-0 ">
            <div className="w-full flex md:justify-between items-baseline flex-col md:flex-row pl-4 dark:bg-dark">
              <h2 className="text-gray-800 text-base font-bold text-2xl pt-3 md:text-2xl dark:text-gray-100">Usuarios</h2>
          ...
          <div className="grid md:grid-cols-botones_crud grid-cols-2 mb-1 gap-y-4 pl-4 pr-4">
            ...
            <div
              onClick={(e) => {
                ...
                setShowModalTitulo("Crear Usuario");
              }}
            ...
            >
              ...
              <h3 className="pr-2">Agregar Usuario</h3>
            </div>
          </div>
                      ...
                      <tr className="hover:bg-violet-200" key={valor.COMP_CODIGO}>
                        ...
                        <td className="border-b border-gray-200 align-middle font-light text-sm whitespace-nowrap px-2 py-2 text-left px-3 py-2">
                          <div className=" space-x-2 flex flex-row justify-center">
                            ...
                            <div
                            className=" border-2 text-white bg-[#1d4ed8] border-[#1d4ed8] rounded hover:!text-[#1d4ed8] hover:bg-white rounded w-9 h-9 grid place-items-center grid-cols-1 cursor-pointer"
                            onClick={(e) => {
                              //setShowModal(true);
                              setShowModalForm(true);
                              setShowModalTitulo("Cambiar Clave");
                              setTypeModal({
                                ...typeModal,
                                cabecera: "Cambiar Clave",
                                cuerpo: "",
                                confirmacion: "Cambiar Clave",
                                codigo: valor.USUA_CODIGO,
                                funcion: "cambiar",
                              });
                            }}
                          >
                            <Icon name="security" size="2xl"/>
                            
                          </div>
                            {valor.USUA_ESTADO==="INACTIVO"?
                            <div
                            ...
                            onClick={(e) => {
                              ...
                              setTypeModal({
                                ...typeModal,
                                cabecera: "Activa usuario",
                                cuerpo: "desea activar este registro ?",
                                confirmacion: "activar usuario",
                                codigo: valor.USUA_CODIGO,
                                funcion: "activar",
                              });
                              dispatch(listaRegistros({
