...
var ButtonNS = /*#__PURE__*/(0, _react.forwardRef)(function (_ref, ref) {
  ...
  var sharedClasses = [block && 'w-full', 'flex', 'items-center', 'justify-center', 'gap-1', 'font-bold', 'outline-none', 'tracking-wider', 'focus:outline-none', 'focus:shadow-none', 'transition-all', 'duration-300', rounded];
